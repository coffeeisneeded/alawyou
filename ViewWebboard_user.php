...
<body>
    ...
    <div class="wallpaper">
        ...
        <div class="webboard center">
            ...
            <form action="ViewWebboard_user.php?QuestionID=<?php echo $_GET["QuestionID"]; ?>&Action=Save" method="post" name="frmMain" id="frmMain">
                <table class="table table-bordered">
                    <thread>
                        <tr>
                ...
                <a href="webboard_user.php">Back to Webboard</a>
            </form>
        </div>
    </div>
</body>
